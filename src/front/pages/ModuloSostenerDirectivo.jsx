...
const INFO_DIM = {
    D1: { corto: "Gobernanza", idea: "Cómo lideras y decides sobre la IA en la institución." },
    D2: { corto: "Docentes", idea: "Cómo acompañas y formas a tu equipo docente." },
    D3: { corto: "Ética y datos", idea: "Cómo proteges a los estudiantes y su información." },
    D4: { corto: "Impacto", idea: "Cómo mides resultados y rindes cuentas a la comunidad." },
};
...
const ModuloSostenerDirectivo = ({ userData, apiFetch, onNavigate }) => {
    ...
    // ═══════════ AUTOEVALUACIÓN: estado del recorrido ═══════════
                    ...
                    <div className="sq-page animate-fade-in" ref={cuestionarioTopRef}>
                        ...
                        {qFase === "intro" && (
                            <section className="sq-card sq-intro">
                                <h2>Evaluación institucional de IA</h2>
                                <p className="sq-lead">
                                    24 afirmaciones sobre cómo lideras el uso de la IA en tu institución, organizadas en 4 dimensiones.
                                    Toma unos 5 minutos. Responde con lo que ocurre hoy, no con lo que está planeado.
                                </p>
                        ...
                        {qFase === "resumen" && (
                            <section className="sq-card sq-resumen">
                                ...
                                <p className="sq-lead">
                                    Así quedó la evaluación institucional. Despliega una dimensión para ver sus 6 respuestas y cambiar cualquiera antes de guardar.
                                </p>
                                ...
                                <div className="sq-res-actions">
                                    ...
                                    <button className="sq-btn-primary" onClick={handleSave} disabled={loading || totalRespondidas < 24}>
                                        {loading ? "Guardando..." : "Finalizar y guardar evaluación institucional"}
                                    </button>
                                </div>
                            </section>
                        )}
